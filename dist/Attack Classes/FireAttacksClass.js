...
export class Ember extends Attack {
    constructor() {
        super("Ember", "Discard a Fire energy from this Pokémon.", 30, 0, ["fire", "normal"], [1, 0], // 1 fire energy required, 0 normal
        0, "");
    }
...
export class FireClaws extends Attack {
    constructor() {
        super("Fire Claws", undefined, 60, 0, ["fire", "normal"], [1, 2], 0, "");
    }
    attackAction(defender, attacker) {
        if (!attacker.checkEnergyRequirements(this.EnergyType, this.EnergyCost)) {
...
export class FireSpin extends Attack {
    constructor() {
        super("Fire Spin", "Discard 2 Fire energy from this Pokémon.", 150, 0, ["fire", "normal"], [2, 2], 0, "");
    }
    attackAction(defender, attacker) {
        if (!attacker.checkEnergyRequirements(this.EnergyType, this.EnergyCost)) {
...
export class CrimsonStorm extends Attack {
    constructor() {
        super("Crimson Storm", "Discard 2 Fire energy from this Pokémon.", 200, 0, ["fire", "normal"], [2, 2], 0, "");
    }
    attackAction(defender, attacker) {
        if (!attacker.checkEnergyRequirements(this.EnergyType, this.EnergyCost)) {
...
//# sourceMappingURL=FireAttacksClass.js.map