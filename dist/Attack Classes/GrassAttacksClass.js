...
export class VineWhip extends Attack {
    ...
    attackAction(defender, attacker) {
        ...
        //  log success
        console.log(`Vine Whip deals ${totalDamage} damage to ${defender.pokemonName}`);
        return true;
    }
}
export class RazorLeaf extends Attack {
    constructor() {
        super("Razor Leaf", undefined, // no description
        60, // damage
        0, // damageAddOn
    ...
    attackAction(defender, attacker) {
        ...
        defender.applyDamage(totalDamage);
        //  log success
        console.log(`Razor Leaf deals ${totalDamage} damage to ${defender.pokemonName}`);
        return true;
    }
}
export class MegaDrain extends Attack {
    constructor() {
        super("Mega Drain", undefined, 80, // damage
        0, // damageAddOn
        ["grass", "normal"], // energy types: grass and normal
    ...
    attackAction(defender, attacker) {
        ...
        attacker.heal(30);
        // Log success
        console.log(`Mega Drain deals ${totalDamage} damage to ${defender.pokemonName} and heals attacker for 30 HP`);
        return true;
    }
}
export class GiantBloom extends Attack {
    constructor() {
        super("Giant Bloom", undefined, 60, // damage
        0, // damageAddOn
    ...
    attackAction(defender, attacker) {
        ...
        attacker.heal(40);
        // Log success
        console.log(`Giant Bloom deals ${totalDamage} damage to ${defender.pokemonName} and heals attacker for 40 HP`);
        return true;
    }
}
//# sourceMappingURL=GrassAttacksClass.js.map