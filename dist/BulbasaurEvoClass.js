...
export class BulbasaurCard extends PokemonCard {
    constructor() {
        ...
        super(1, // evolutionStage (1 = basic)
        "", // evolvesFrom
...
export class IvysaurCard extends PokemonCard {
    constructor() {
        ...
        super(2, "Bulbasaur", "Ivysaur", false, "grass", 90, 2, "fire", "ivysaur.png", "When the bulb on its back grows large, it appears to lose the ability to stand on its hind legs.", 2, pokedexInfo, attacks, undefined);
    }
}
export class VenusaurCard extends PokemonCard {
    constructor() {
        ...
        super(3, "Ivysaur", "Venusaur", false, "grass", 160, 3, "fire", "venusaur.png", "The plant blooms when it is absorbing solar energy. It stays on the move to seek sunlight.", 3, pokedexInfo, attacks, undefined);
    }
}
export class VenusaurEXCard extends PokemonCard {
    constructor() {
        ...
        super(3, "Ivysaur", "Venusaur EX", true, // isEX
        "grass", 190, 3, "fire", "venusaur_ex.png", "A powerful Venusaur that harnesses intense sunlight to deliver devastating attacks and recover strength.", 4, pokedexInfo, attacks, undefined);
    }
}
//# sourceMappingURL=BulbasaurEvoClass.js.map